...
export default class SignUp extends React.Component<any, any> {
    ...
    config([ 'chooseWXPay' ], () => {
      pay({
        ...
        (res) => {
          ...
          // _.isObjectLike(res) ?
          //   log(JSON.stringify(res), window.location.href + "--" + window.ENV.configUrl,
          // JSON.stringify(getBrowser())) : log(res, window.location.href + "--" + window.ENV.configUrl,
          // JSON.stringify(getBrowser()));
  ...
  render() {
      ...
      return (
        <div id="slider-container" className="swiper-container">
          ...
          <div className="pagination">
            ...
            <div className={`bg-hr member3`} style={{
              left: `${window.innerWidth * 0.74 * 0.5 + 10}px`, width: `${(window.innerWidth * 0.74 - 140) / 2 + 10}px`
            }}/>
    ...
    const renderMenu = (showMember = {}) => {
      console.log('renderMenu', showMember)
      let name = ''
      switch(showMember.id) {
        case 1:
          name = '专业版'
    ...
    return (
      <div className="rise-pay">
        ...
        <PayInfo pay={() => this.risePay()} close={(callback) => {
          this.setState({ showPayInfo: false })
          callback()
        }}
