      ...
      <div className="point-tip">
        ...
        {Number(memberType) === 3 || Number(memberType) === 4?(
          <div className="point-tip-container">
            ...
            1.【小课训练营】的学习模式：你将与20位小伙伴形成小组、并肩战斗，有教练带着你手把手深度学习，50%以上的学习都是互动、举例，而非枯燥讲解
            <br/>
            <br/>2.9年6个行业50家公司总结出的方法，让你用顶级公司的方法培养自己
            <br/>
            <br/>3.一年可在所有课程中选择36门小课学习，针对职场最值钱的几种能力来学习，以提升竞争力
            <br/>
            <br/>4.全年不间断、超过100场的学习活动，建立自己的学习圈子
            <br/>包括：各领域大咖直播、案例吊打、线下工作坊、各种资源分享会……
            <br/>
            <br/>5.帮你搭建BAT、世界500强等高质量职场资源
            <br/>
            <br/>6.优秀学员可以进入圈外教练体系，圈圈亲自带你飞，并有机会成为圈外的合作伙伴（有钱的那种）
            ...
            A:不会，原因如下：
            <br/>            1）【圈外同学】会持续研发和上线新课程，未来还会联合更多优质的学习资源开设丰富多样的主题课程。因此，一年内上线的【圈外同学】课程想全部跟着学完并不简单。我们鼓励大家需要根据个人需求来规划课程学习。
            <br/>            2）【圈外同学】是会陆续涨价的哦，早期当然最划算啦。<br/><br/>


            <b style={{fontSize:"16px"}}>Q:圈外同学】和训练营有什么区别？我参加过训练营还需要报名参加【圈外同学】吗？</b><br/>
            A:两者的区别在于：【圈外同学】提供多种能力每天的刻意练习，训练营则是集中时间、由教练带领、深入练习某个能力。前者培养广度，是每天学习的工具，后者针对深度。<br/><br/>
